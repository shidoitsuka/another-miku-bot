...
exports.run = (bot, message, args) => {
  ...
  // prettier-ignore
  bot.db.get("guildConf", `${message.guild.id}.greetingChannel`) == null ? welcome = "not specified!" : welcome = bot.channels.cache.get(bot.db.get("guildConf", `${message.guild.id}.greetingChannel`)).name;
  // prettier-ignore
